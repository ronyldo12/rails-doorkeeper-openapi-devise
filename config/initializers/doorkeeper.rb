...
Doorkeeper.configure do
  ...
  Doorkeeper::JWT.configure do
    ...
    #secret_key ENV["OAUTH_JWT_SECRET_KEY"]
    ...
    # `secret_key`.
    secret_key_path ENV["OAUTH_OPENID_SIGNING_KEY_FILE_PATH"]
  ...
  grant_flows %w(authorization_code client_credentials implicit_oidc password)
